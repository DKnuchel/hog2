...
exp.add_resource("hog2", "../expBuild24/Hog2", symlink=True) # revision hash als doc; # potential als symlink
exp.add_resource("pdb", "../expBuild24/pdbs", symlink=True)
exp.add_resource("input", "../expBuild24/24puzzles", symlink=True)
...
ALGORITHMS = {
   ...
   "static 6-6-6-6": ["-m", "PDB", "--static", "-p", "((1,2,5,6,7,12)(3,4,8,9,13,14)(10,11,15,16,20,21)(17,18,19,22,23,24))"] ,
...
report_initial_phod_static = ScatterPlotReport(
        attributes=["initial"],
        filter_algorithm=["pho-dual", "static 6-6-6-6"],
...
exp.add_report(report_initial_phop_dynd, name="report_initial_phop_dynd")
exp.add_report(report_expanded_phop_dynd, name="report_expanded_phop_dynd")
