...
report_initial_phop_static = ScatterPlotReport(
        attributes=["initial"],
...
exp.add_report(report_initial_phop_static, name="Initial_h_value_phop_static")
exp.add_report(report_initial_phop_dynp, name="Initial_h_value_phop_dynp")
exp.add_report(report_initial_dynp_dynd, name="Initial_h_value_dynp_dynd")
exp.add_report(report_expanded_phop_static, name="Expansions_phop_static")
exp.add_report(report_expanded_phop_dynp, name="Expansions_phop_dynp")
exp.add_report(report_expanded_dynp_dynd, name="Expansions_dynp_dynd")
